...
public class SwerveSubsystem extends SubsystemBase {
   ...
   */
  // private Command driveWithSetpointGenerator(Supplier<ChassisSpeeds>
  // robotRelativeChassisSpeed)
  // throws IOException, ParseException {
  // SwerveSetpointGenerator setpointGenerator = new
  // SwerveSetpointGenerator(RobotConfig.fromGUISettings(),
  ...
  // setpointGenerator.generateSetpoint(prevSetpoint.get(),
   ...
   */
  // public Command
  // driveWithSetpointGeneratorFieldRelative(Supplier<ChassisSpeeds>
  // fieldRelativeSpeeds) {
  // try {
  // return driveWithSetpointGenerator(() -> {
  // return ChassisSpeeds.fromFieldRelativeSpeeds(fieldRelativeSpeeds.get(),
  // getHeading());
