...
public class SystemScoreAmp extends SequentialCommandGroup {
  /** Creates a new SystemScoreAmp. */
  public SystemScoreAmp() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        // new PivotSetPosition(Pivot.AMP_SHOT),
        // new WaitCommand(1.5),
        new MagazineSetPower(.2),
        new ShooterSetPower(-.2),
        new IntakeSetPower(.2)
    // new WaitCommand(1.5),
