...
public class LEDLights extends SubsystemBase {
    ...
    private final Spark m_blinkin = new Spark(Constants.PWM.LIGHTS_PORT);

    public LEDLights() {
        this.setDefaultCommand(this.defaultCmd());
    }
    ...
    public Command hasCoral() {
        return runOnce(() -> this.set(PatternID.RED));
    }

    public Command hasAprilTag() {
        return runOnce(() -> this.set(PatternID.GREEN));
    }

    public Command defaultCmd() {
        return runOnce(() -> this.set(PatternID.BPM_OCEAN_PALETTE));
    }
}
